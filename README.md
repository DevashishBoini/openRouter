...
Edit `src/main/resources/application.properties` and update the database connection fields:
...
For Supabase, get connection details from **Settings → Database → Connection String[Session Pooler]**
...
│   │   ├── dbModel/
│   │   │   ├── User.java                 # User entity (email, password, credits)
│   │   │   ├── ApiKey.java               # API keys entity
│   │   │   ├── Company.java              # Company entity
│   │   │   ├── Conversation.java         # Conversations entity
│   │   │   ├── Model.java                # AI models entity
│   │   │   ├── ModelProviderMapping.java # Model-provider relationships
│   │   │   ├── OnRampTransaction.java    # Payment transactions
│   │   │   └── Provider.java             # AI providers entity
│   │   ├── repository/
...
| **ModelProviderMapping** | Relationships between models and providers |
| **OnRampTransaction** | Payment/credit transactions |

All tables are automatically created/updated by Hibernate based on the entity definitions.
...
- **dbModel (Entities):** Database table representations
  - User, ApiKey, Company, Conversation, Model, Provider, etc.
